...
--
-- Servidor: localhost
-- Tempo de Geração: Abr 29, 2013 as 12:32 AM
...
--
-- Banco de Dados: `db_encheivos`
--

-- --------------------------------------------------------

--
-- Estrutura da tabela `lv_cidade`
--

CREATE TABLE IF NOT EXISTS `lv_cidade` (
...
--
-- Extraindo dados da tabela `lv_cidade`
--

INSERT INTO `lv_cidade` (`id`, `nome`, `estado`) VALUES
(1, 'Acrelândia', 1),
(2, 'Assis Brasil', 1),
(3, 'Brasiléia', 1),
(4, 'Bujari', 1),
...
--
-- Estrutura da tabela `lv_curso_funcao`
--

CREATE TABLE IF NOT EXISTS `lv_curso_funcao` (
  `id` int(7) NOT NULL AUTO_INCREMENT,
...
--
-- Extraindo dados da tabela `lv_curso_funcao`
--

INSERT INTO `lv_curso_funcao` (`id`, `texto`) VALUES
(1, 'Formador'),
(2, 'Servo'),
(3, 'Servo Auxiliar'),
(4, 'Músico'),
...
--
-- Estrutura da tabela `lv_estado`
--

CREATE TABLE IF NOT EXISTS `lv_estado` (
  `id` int(7) NOT NULL AUTO_INCREMENT,
  `nome` varchar(255) NOT NULL,
...
--
-- Extraindo dados da tabela `lv_estado`
--

INSERT INTO `lv_estado` (`id`, `nome`, `sigla`) VALUES
(1, 'Acre', 'AC'),
(2, 'Alagoas', 'AL'),
(3, 'Amapá', 'AP'),
(4, 'Amazonas', 'AM'),
...
--
-- Estrutura da tabela `lv_info_sacramento`
--

CREATE TABLE IF NOT EXISTS `lv_info_sacramento` (
  `id` int(7) NOT NULL AUTO_INCREMENT,
  `texto` varchar(255) NOT NULL,
...
--
-- Estrutura da tabela `lv_semestre`
--

CREATE TABLE IF NOT EXISTS `lv_semestre` (
  `id` int(7) NOT NULL AUTO_INCREMENT,
...
--
-- Estrutura da tabela `lv_setor`
--

CREATE TABLE IF NOT EXISTS `lv_setor` (
  `id` int(7) NOT NULL AUTO_INCREMENT,
  `texto` varchar(255) NOT NULL,
  `valor` int(7) NOT NULL,
  PRIMARY KEY (`id`)
...
--
-- Estrutura da tabela `lv_veiculo`
--

CREATE TABLE IF NOT EXISTS `lv_veiculo` (
  `id` int(7) NOT NULL AUTO_INCREMENT,
  `texto` varchar(255) NOT NULL,
  `valor` int(7) NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `tb_curso` (
  ...
  `cidade` int(7) DEFAULT NULL,
  `estado` int(7) DEFAULT NULL,
  `detentor` int(7) NOT NULL,
  PRIMARY KEY (`id`)
...
--
-- Estrutura da tabela `tb_curso_associado`
--

CREATE TABLE IF NOT EXISTS `tb_curso_associado` (
  `id` int(7) NOT NULL AUTO_INCREMENT,
  `participante` int(7) DEFAULT NULL,
  `usuario` int(7) DEFAULT NULL,
  `curso` int(7) NOT NULL,
  `funcao` int(7) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tb_participante` (
  ...
  `celular3` varchar(255) DEFAULT NULL,
  `email1` varchar(255) DEFAULT NULL,
  `email2` varchar(255) DEFAULT NULL,
  `nome_mae_responsavel` varchar(255) DEFAULT NULL,
  `nome_pai_responsavel` varchar(255) DEFAULT NULL,
  `estado_civil` varchar(255) DEFAULT NULL,
  `nome_conjuge` varchar(255) DEFAULT NULL,
  `profissao` varchar(255) DEFAULT NULL,
  `instituicao_nome` varchar(255) DEFAULT NULL,
  `instituicao_endereco` varchar(255) DEFAULT NULL,
  `instituicao_numero` varchar(255) DEFAULT NULL,
  `instituicao_bairro` varchar(255) DEFAULT NULL,
  `instituicao_cep` varchar(255) DEFAULT NULL,
  `instituicao_cidade` int(7) DEFAULT NULL,
  `instituicao_estado` int(7) DEFAULT NULL,
  `info_sacramento` int(7) DEFAULT NULL,
  `setor` int(7) DEFAULT NULL,
  `veiculo` int(7) DEFAULT NULL,
...
--
-- Estrutura da tabela `tb_participante_semestre`
--

CREATE TABLE IF NOT EXISTS `tb_participante_semestre` (
  `id` int(5) NOT NULL AUTO_INCREMENT,
  `participante` int(5) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tb_usuario` (
  ...
  `semestre` int(5) NOT NULL COMMENT 'semestre vigente',
  `tipo` int(7) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=7 ;