<?php 
    $usuario = $dataAcess->getUsuario($associar);
    $cursosAssociados = $dataAcess->obterCursoAssociado($usuario->getId());
?>

<div class="tab-pane <?php echo (isset($associar)) ? 'active' : '' ?>" id="tab2">
    <pre class="titulo">Associar Usu&aacute;rio</pre>	
    <form class="well">
        <div class="row-fluid">
            <div class="span12">
        ...
        <input type="hidden" class="hdnUsuarioAssociadoId" value="<?php echo $usuario->getId() ?>" />
